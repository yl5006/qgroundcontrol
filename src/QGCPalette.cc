...
DECLARE_QGC_COLOR(button,               "#ffffff", "#ffffff", "#626270", "#33444c")
    DECLARE_QGC_COLOR(buttonText,           "#9d9d9d", "#000000", "#202020", "#ffffff")
DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#3a3a3a", "#2fa0af")
    DECLARE_QGC_COLOR(buttonHighlightText,  "#2c2c2c", "#ffffff", "#2c2c2c", "#000000")
DECLARE_QGC_COLOR(primaryButton,        "#585858", "#8cb3be", "#8cb3be", "#10ebbf")
