...
:   QGeoTiledMappingManagerEngine()
{
    ...
    #define QGCGEOMAPTYPE(a,b,c,d,e,f)  QGeoMapType(a,b,c,d,e,f,QByteArray("GroundStation"), cameraCaps)
    ...
    mapTypes << QGCGEOMAPTYPE(QGeoMapType::HybridMap,         "Bing Hybrid Map",          "Bing hybrid map",                  false,  false,  UrlFactory::BingHybrid);
	    ...
	    // Gaode
    mapTypes << QGCGEOMAPTYPE(QGeoMapType::StreetMap,         "Gaode Street Map",          "Gaode street map",              false,  false,  UrlFactory::GaodeMap);
