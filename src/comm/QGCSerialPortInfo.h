...
public:
    ...
    static const int px4VendorId =                          1155;//1155;//9900;   /////< Vendor ID for Pixhawk board (V2 and V1) and PX4 Flow
    ...
    static const int pixhawkFMUV2ProductId =                22336;//22336;//17;     /  ///< Product ID for Pixhawk V2 board
