...
Item {
    ...
    readonly property string pauseTitle:            qsTr("暂停任务")
    ...
    readonly property string gotoTitle:             qsTr("移动")
    ...
    readonly property string startMissionMessage:       qsTr("开始当前任务，如果在地面会自动起飞.")
             property string resumeMissionMessage:      qsTr("恢复当前任务. This will re-generate the mission from waypoint %1, takeoff and continue the mission.").arg(_resumeMissionItem)
