...
Button {
    ...
    property bool   _showDotBorder:     false
    property bool   _showVerticalDotBorder: false
    property color   bordercolor:  Qt.rgba(0.0627, 0.9216, 0.749, 1)
    property color   startcolor:   Qt.rgba(0.0627, 0.9216, 0.749, 0)
    property color   middlecolor:  Qt.rgba(0.0627, 0.9216, 0.749, 0.35)
    property color   stopcolor:    Qt.rgba(0.0627, 0.9216, 0.749, 0)
    property bool   _dottedAnimation:     true
    ...
    style: ButtonStyle {
            ...
            background: Item {
                ...
                Rectangle {
                    ...
                    LinearGradient {
                           ...
                           gradient: Gradient {
                               ...
                               GradientStop { position: 0.5; color:  middlecolor }
                ...
                PathDraw {
                        ...
                        point2y:parent.y
                        dottedAnimation: _dottedAnimation
                        visible:  _showDotBorder
                    }
                PathDraw {
                        lineWidth: 2
                        lineColor: bordercolor
                        point1x:parent.x+parent.width
                        point1y:parent.y
                        point2x:parent.x+parent.width
                        point2y:parent.y+parent.height
                        dottedAnimation: _dottedAnimation
                        visible:  _showDotBorder &&_showVerticalDotBorder
                    }
                PathDraw {
                        lineWidth: 2
                        lineColor: bordercolor
                        point1x:parent.x
                        point1y:parent.y+parent.height
                        point2x:parent.x+parent.width
                        point2y:parent.y+parent.height
                        dottedAnimation: _dottedAnimation
                        visible:  _showDotBorder
