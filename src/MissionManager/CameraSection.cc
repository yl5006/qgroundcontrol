...
void CameraSection::appendSectionItems(QList<MissionItem*>& items, QObject* missionItemParent, int& nextSequenceNumber)
{
    ...
    if (_specifyCameraMode) {
        MissionItem* item = new MissionItem(nextSequenceNumber++,
                                            ...
                                            NAN,                                    // Audio off/on
                                            NAN, NAN, NAN, NAN, NAN, NAN, NAN, // param 3-7 unused
                                            true,                                   // autoContinue
                                            false,                                  // isCurrentItem
                                            missionItemParent);
        items.append(item);
    ...
    if (_cameraActionFact.rawValue().toInt() != CameraActionNone) {
        ...
        case TakePhotoIntervalDistance:
            item = new MissionItem(nextSequenceNumber++,
                                   ...
                                   0, 0, 0, 0, 0,0,0,                                             // param 4-7 not used
                                   true,                                                    // autoContinue
                                   false,                                                   // isCurrentItem
                                   missionItemParent);
            break;
        ...
        case TakeVideo:
            item = new MissionItem(nextSequenceNumber++,
                                   ...
                                   NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN,     // param 3-7 reserved
                                   true,                        // autoContinue
                                   false,                       // isCurrentItem
                                   missionItemParent);
            break;
        ...
        case StopTakingVideo:
            item = new MissionItem(nextSequenceNumber++,
                                   ...
                                   MAV_FRAME_MISSION,
                                   0,                               // Camera ID, all cameras
                                   NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN, NAN,    // param 2-7 reserved
                                   true,                            // autoContinue
                                   false,                           // isCurrentItem
                                   missionItemParent);
            break;
        ...
        case TakePhoto:
            item = new MissionItem(nextSequenceNumber++,
                                   ...
                                   0,                           // Interval (none)
                                   1,                           // Take 1 photo
                                   NAN, NAN, NAN, NAN, NAN, NAN, NAN,          // param 4-7 reserved
                                   true,                        // autoContinue
                                   false,                       // isCurrentItem
                                   missionItemParent);
            break;
