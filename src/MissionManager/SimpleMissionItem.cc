...
void SimpleMissionItem::_connectSignals(void)
{
    ...
    connect(&_missionItem._param8Fact,  &Fact::valueChanged,                    this, &SimpleMissionItem::_setDirty);
    connect(&_missionItem._param9Fact,  &Fact::valueChanged,                    this, &SimpleMissionItem::_setDirty);
    connect(&_missionItem._param10Fact, &Fact::valueChanged,                    this, &SimpleMissionItem::_setDirty);
