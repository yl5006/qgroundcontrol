...
MapQuickItem {
    ...
    property real   _uavSize:       ScreenTools.defaultFontPixelHeight * 3
    ...
    sourceItem: Item {
        ...
        Image {
            id:                 vehicleIcon
            source:             _adsbVehicle ? (alert ? "/qmlimages/AlertAircraft.svg" : "/qmlimages/AwarenessAircraft.svg") : vehicle.multiRotor?"/qmlimages/airplaneCoper.svg":"/qmlimages/airplanePlane.svg"//vehicle.vehicleImageOpaque
            mipmap:             true
            width:              size
